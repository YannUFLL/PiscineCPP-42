...
void	Form::beSigned(Bureaucrate& bur)
{
...
{
	flux << form.get_name() << "; requiered the rank : " << form.get_requiredSign() << " to be signed; Required the rank : " << form.get_requiredExe() << " to be executed. ";
	return (flux);
}
